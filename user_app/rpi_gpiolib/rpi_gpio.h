...
#define RPI_GPIO_P1MASK (uint32_t)((0x01 << 2) | (0x01 << 3) | (0x01 << 4) | (0x01 << 7) | (0x01 << 8) | (0x01 << 9) | \
                                (0x01 << 10) | (0x01 << 11) | (0x01 << 14) | (0x01 << 15) | (0x01 << 17) | (0x01 << 18) | \
                                (0x01 << 22) | (0x01 << 23) | (0x01 << 24) | (0x01 << 25) | (0x01 << 27))
